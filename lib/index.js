...
const BezierEasing_1 = __importDefault(require("./utils/BezierEasing"));
const buzzier_1 = require("./utils/buzzier");
const Xarrow = (props) => {
    let { startAnchor, endAnchor, label, color, lineColor, headColor, strokeWidth, headSize, path, curveness, dashness, passProps, SVGcanvasProps, arrowBodyProps, arrowHeadProps, divContainerProps, extendSVGcanvas, middleLabelFactor = 0.5, middleLabelEasingDivider = 1 } = props, extraProps = __rest(props, ["startAnchor", "endAnchor", "label", "color", "lineColor", "headColor", "strokeWidth", "headSize", "path", "curveness", "dashness", "passProps", "SVGcanvasProps", "arrowBodyProps", "arrowHeadProps", "divContainerProps", "extendSVGcanvas", "middleLabelFactor", "middleLabelEasingDivider"]);
    ...
    const updatePosition = (positions) => {
        ...
        const middleLabelFactorEasing = BezierEasing_1.default(0 + highIfDiffHigh, 0, 1 - highIfDiffHigh, 1);
